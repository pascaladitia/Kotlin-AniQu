...
application {
    mainClass.set("com.pascal.ApplicationKt")
    // adding this for fatjar
    project.setProperty("mainClassName", "com.pascal.ApplicationKt")
...
ktor {
    openApi {
        title = "Kotlin AniQu API"
        version = "1.0.0"
        summary = "AniQu API built with Ktor framework"
        description = "This is a complete AniQu API with user authentication."
